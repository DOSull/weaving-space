...
get_grid_cell_polygon <- function(face_to_face_distance = 1, n_sides = 4) {
  ...
  return((corners %>% list() %>% st_polygon()))
}
...
get_cell_strands <- function(n = 4, S = 1, width = 1, 
                             orientation = 0, n_slices = 1) {
  # get the base grid cell polygon
  cell <- get_grid_cell_polygon(face_to_face_distance = S, n = n)
...
get_all_cell_strands <- function(n = 4, S = 1, width = 1, 
                                 orientations = c(0, 90), 
...
get_visible_cell_strands <- function(n = 4, S = 1, width = 1, 
  ...
  # return(c(all_polys, mask_poly))
  return(all_polys %>% sapply("[") %>% st_sfc())
}
