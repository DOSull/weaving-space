...
# Introduction
This document aims to explain how biaxial weaves have been implemented in [`biaxial_weave_units.R`](biaxial-weave-units.R) including references to source literature, example code snippets etc. References to code are accurate at time of writing, but the code is subject (even likely) to change.
