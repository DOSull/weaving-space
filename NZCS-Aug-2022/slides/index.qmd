...
![](images/imd-escher.png){.fragment .fade-in-then-out fragment-index=2 width="1000"}

![](images/gwr-example.png){.fragment .fade-in-then-out fragment-index=3 width="1000"}

![](images/election-2016-weave.png){.fragment .fade-in fragment-index=4 width="1000"}
:::
...
If you have a project where this might work, please reach out!
