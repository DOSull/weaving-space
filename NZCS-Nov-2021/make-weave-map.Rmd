...
knitr::opts_knit$set(root.dir = "~/Documents/code/weaving-space")
```
...
Also see: [online full screen version of the above map](example-map-3.html) and an [alternate map using the cube weave](example-map-2.html)
