...
class Tileable:
    ...
    def merge_fragments(
                self, frags:list[geom.Polygon]) -> list[geom.Polygon]:
        """
    ...
    def regularise_elements(self) -> None:
        ...
        for id in ids:
            fragment_set = list(self.elements[self.elements.element_id == id].geometry)
        ...
        self.regularised_tile.geometry[0] = self.regularised_tile.geometry[0].simplify(
            self.spacing / 100
        )
        return None
