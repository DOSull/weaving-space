...
def get_pattern(
  tie_up:np.ndarray, treadling:np.ndarray, threading:np.ndarray,
...
def _encode_biaxial_weave(
  pattern:np.ndarray, warp:np.ndarray, weft:np.ndarray) -> np.ndarray:
...
def make_twill_pattern(
  n:Union[int, tuple[int]] = 2, warp_n:int = 2, weft_n:int = 2) -> np.ndarray:
...
def make_this_pattern(
  tie_up:np.ndarray, threading:np.ndarray = None,
  treadling:np.ndarray = None, warp_n:int = 1, weft_n:int = 1
  ) -> np.ndarray:
