...
surface composed of criss-crossing strands.
...
def get_pattern(
  ...
  The "twill", "basket" and "plain" options should guarantee this. If the
  ...
  Returns:
    np.ndarray: the matrix weave pattern generated by the supplied parameters.
...
def _encode_biaxial_weave(
  ...
  """Encode a biaxial weave pattern as below.
