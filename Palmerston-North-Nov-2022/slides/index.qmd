...
cairo_tile.plot(r = 1, show_vectors = True).set_axis_off()
```
...
![](images/world-anthromes-triaxial-weave.png){.fragment .fade-in-then-out fragment-index=2 width="1000"}

![](images/gwr-example.png){.fragment .fade-in-then-out fragment-index=3 width="1000"}

![](images/imd-annuli.png){.fragment .fade-in-then-out fragment-index=4 width="1000"}

![](images/imd-h3-symbols.png){.fragment .fade-in fragment-index=5 width="1000"}
:::
...
+ Potential for use in combination with hierarchical indices like H3?
