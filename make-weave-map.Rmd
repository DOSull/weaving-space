...
rect11_unit$primitive %>% plot(border = "white")
```
...
rect32_unit$primitive %>% plot(border = "white")
```
...
rect34_unit$primitive %>% plot(border = "white")
```
...
twill_unit$primitive %>% plot(border = "white")
```
...
basket_unit <- 
  get_biaxial_weave_unit(spacing = 200, type = "basket", n = 2, 
                         aspect = 0.6, ids = "ab|cd", crs = st_crs(region))
basket_unit$primitive %>% plot(border = "white")
```
...
this_unit <- 
  get_biaxial_weave_unit(spacing = 200, type = "this", aspect = 0.8,
                        ids = "a|b", crs = st_crs(region))
this_unit$primitive %>% plot(border = "white")
```
...
hex_unit$primitive %>% plot(border = "white")
```
...
cube_unit$primitive %>% plot(border = "white")
```
...
diamond_unit$primitive %>% plot(border = "white")
```
...
```{r}
twill_unit$primitive %>% sf_square_to_diamond() %>% plot(border = "white")
```
