...
format: 
  revealjs:
    ...
    image: images/08-ak-imd-basket.png
    include-in-header:
      text: "<meta property='og:description' content='A new approach to making area maps with many data attributes using beautiful tiled and woven patterns'><meta property='og:image' content='images/08-ak-imd-basket.png'>"
---
...
![](images/05-dorling-chernoff-faces.jpg "Figure 8.10 in Dorling D. 2012. The Visualisation of Spatial Social Structure. Chichester, England: Wiley."){.fragment .fade-in-then-out fragment-index=4 width="500"}

![](images/06-dot-map.png "This approach is older than you might imagine, see Jenks GF. 1953. ‘Pointilism’ as a cartographic technique. The Professional Geographer. 5(5) 4–6."){.fragment .fade-in fragment-index=5 width="800"}
:::
...
[Elements in a tiling 'pick up' data from area units by overlay so we can combine multiple choropleths into a single map]{.fragment data-fragment-index="1"}

[Giving two kinds of map of complex multi&shy;variate data (tiled and woven)]{.fragment data-fragment-index="2"}

&nbsp;
:::
::: {.column width="30%"}
<img src="images/qr-weaving-space-repo.svg">
:::
::::

::: aside
[Maps on the next slide are of the IMD. See: Exeter DJ, Zhao J, Crengle S, Lee A, Browne M, 2017, [The New Zealand Indices of Multiple Deprivation (IMD): A new suite of indicators for social and health research in Aotearoa, New Zealand](https://dx.plos.org/10.1371/journal.pone.0181260) _PLOS ONE_ **12**(8) e0181260]{.fragment data-fragment-index="2"}
:::

## {transition="none" data-background-image="images/07-ak-imd-4-triangles.png" background-size="contain"}

## {transition="none" data-background-image="images/08-ak-imd-basket.png" background-size="contain"}
...
### Live demo time! {style="font-size:72px;"}
...
<h3 style="font-size:144px;text-align:center;">Questions?</h3>
